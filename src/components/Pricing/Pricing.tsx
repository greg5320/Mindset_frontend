          ...
          {pricingData.map((pkg) => (
            <div key={pkg.id} id={pkg.id} className="package">
              ...
              >
                ...
                <span
                  className={`package__arrow ${
                    openPackage === pkg.id ? "package__arrow--open" : ""
                  }`}
                >
                  ▼
                </span>
              ...
              <div
                className={`package__content ${
                  openPackage === pkg.id ? "package__content--open" : ""
                }`}
              >
                <div className="pricing-cards">
                  {pkg.tiers.map((tier, index) => (
                    <div
                      key={index}
                      className={`pricing-card pricing-card--${pkg.color} ${
                    ...
                    >
                      ...
                      {tier.oldPrice && (
                        <div className="pricing-card__old-price">
